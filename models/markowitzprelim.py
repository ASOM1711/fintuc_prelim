...
def optimizar_markowitz(train_returns, lam, perdida_max_anual, perfil,
    ...
    # restricción de presupuesto: lo que no se invierte queda en caja chica
    ...
    # para muy_conservador (0%) el modelo naturalmente deriva todo a caja chica
